...
module.exports = {
	'sistemaCantareira': [
		'Até 1º de setembro de 2004, a Sabesp não considerava no cálculo do volume total a reserva estratégica pensada na estruturação do sistema, segundo a companhia, "com o objetivo de manter um desnível seguro entre as represas e para garantir maior eficiência e segurança na transferência de água até a represa do Cachoeira". Depois desta data, com a renovação da outorga, o volume da reserva passou a ser incorporado. Segundo a companhia, a diferença é de 20%. Levantamento do eco, porém, indica que a variação é, na realidade, de 16,4%, valor que foi considerado nesse infográfico. Para facilitar a visualização dos dados e a comparação entre os períodos, essa diferença já foi incluída mesmo nos dados anteriores a data em que a nova métrica foi adotada.'
	],
	'sistemaAltoTiete': [
		'Não há dados disponíveis no mês de novembro de 2004. Questionada sobre os valores e a ausência dos dados, a assessoria de imprensa da Sabesp não se posicionou.'
	]
};
...
},{"./details":6,"./filter":7,"./icons":8,"./load":10,"./parse":11,"./pluviometria":12,"./stories":13,"./updateInfo":14,"./volume":15,"d3":1,"jquery":2,"moment":4,"moment/locale/pt-br":3,"underscore":5}],10:[function(require,module,exports){
'use strict';
...
},{"d3":1,"jquery":2}],11:[function(require,module,exports){
'use strict';
...
},{"d3":1,"moment":4,"underscore":5}],12:[function(require,module,exports){
'use strict';
...
},{"./icons":8,"d3":1}],13:[function(require,module,exports){
'use strict';
...
},{"d3":1,"jquery":2,"moment":4,"underscore":5}],14:[function(require,module,exports){
'use strict';
...
},{"./icons":8,"jquery":2,"moment":4,"moment/locale/pt-br":3}],15:[function(require,module,exports){
'use strict';
